...
# NEW: Excel workbook
OUTPUT_EXCEL = (
    DATA_DIR / "normal_lr_predictions.xlsx"
)
...
def extract_size_association(
    df,
):

    """
    Extracts A, B, or C from source_file.
    ...
    if "source_file" not in df.columns:
        ...
        raise KeyError(
            "Column 'source_file' was not found.\n"
            "It is required to associate specimens "
            "with Size A, B, or C."
        )
    ...
    if size_series.isna().any():
        ...
        print(
            "\nWARNING: Some specimens could not be "
            "assigned to Size A, B, or C."
        )

        print(
            "Unrecognized source_file values:"
        )
...
def leave_one_out_linear_regression(
    ...
    # --------------------------------------------------------
    # Ensure size information follows X index
    # --------------------------------------------------------
    ...
    for fold, (
        ...
        # Keeps your original convention:
        ...
        # ====================================================
        # NEW:
        # Table containing exactly the points in the figure
        # ====================================================
        ...
        # Add feature values as extra columns
    ...
    # ========================================================
    # Convert plotted predictions to DataFrame
    # ========================================================
...
def save_results_to_excel(
    ...
    with pd.ExcelWriter(
        ...
        original_predictions.to_excel(
            writer,
            sheet_name="Original Predictions",
            index=False,
        )
        ...
        cleaned_predictions.to_excel(
            writer,
            sheet_name="Cleaned Predictions",
            index=False,
        )
        ...
        comparison_df.to_excel(
            writer,
            sheet_name="Performance Comparison",
            index=False,
        )
...
def main():
    ...
    # ========================================================
    # Extract A/B/C BEFORE select_features()
    # ========================================================

    size_association_all = extract_size_association(
        df_all
    )
    ...
    # ========================================================
    # Important:
    # Keep only size labels corresponding to cleaned rows
    # ========================================================

    size_association = (
        size_association_all
        .loc[
            df_clean.index
        ]
        .copy()
    ...
    # ========================================================
    # Get size information for cleaned dataset
    # ========================================================

    size_association_cleaned = (
        size_association
        .loc[
            X_cleaned.index
        ]
    ...
    # ========================================================
    # Save information about removed specimens
    # ========================================================
